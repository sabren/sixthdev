...
class MyAdminApp(AdminApp):
    def list_project(self):
        self.write(workshop.generic_list(self.clerk, Project, "ws_generated.py"))
    def list_goal(self):
        self.write(workshop.generic_list(self.clerk, Goal, "ws_generated.py"))
    def list_task(self):
        self.write(workshop.generic_list(self.clerk, Task, "ws_generated.py"))
    def list_class(self):
        self.write(workshop.generic_list(self.clerk, Class, "ws_generated.py"))
    def list_attr(self):
        self.write(workshop.generic_list(self.clerk, Attr, "ws_generated.py"))
    def list_link(self):
        self.write(workshop.generic_list(self.clerk, Link, "ws_generated.py"))
    def list_join(self):
        self.write(workshop.generic_list(self.clerk, Join, "ws_generated.py"))
    ...
    def edit_project(self):
        obj = self._getInstance(Project)
        self.write(workshop.generic_edit(self.clerk,  obj,"ws_generated.py"))
    def edit_goal(self):
