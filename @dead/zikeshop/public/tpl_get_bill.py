    ...
    def fetch(self, model={}):
        ...
        for _ in range(_max_):
            ...
            if _ == 0:
                ...
                zres = zres + 'h3'
                zres = zres + '>'
                zres = zres + 'Select an address to bill to...'
                zres = zres + '<'
                zres = zres + '/h3'
                zres = zres + '>'
                zres = zres + '<'
                zres = zres + 'select name=\"billAddressID\"'
                zres = zres + '>'
            zres = zres + '<'
        ...
        zres = zres + '>'
        zres = zres + '<'
        zres = zres + 'input type=\"hidden\" name=\"whichone\" value=\"bill\"'
        zres = zres + '>'
        zres = zres + '<'
