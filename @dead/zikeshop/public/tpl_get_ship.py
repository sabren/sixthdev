...
def show():
    ...
    print "<h1>Shipping Address</h1>"

    if model.addressbook:

        print '<form action="checkout.py" method="POST">'
        print '<h3>Select an address to ship to...</h3>'
        print '<select name="shipAddressID">'
        ...
        print '<h3>enter a <b>shipping</b> address below:</h3>'
    ...
    print '<input type="hidden" name="whichone" value="ship">'
